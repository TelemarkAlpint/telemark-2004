  ...
  <BODY
	...
	BGCOLOR="#758DB8"> <HR WIDTH="100%"> 
	 <P><FONT STYLE="font-family: Verdana, Arial; font-size: 12pt">
		<B>Innleggingsside for markedsplassen</B></FONT> </P> 
	  ...
	  STYLE="font-family: Verdana, Arial; font-size: 10pt"> 
		<TR> 
		  <TD VALIGN="top" WIDTH="407" ROWSPAN="0"> 
			 <FORM NAME="mainForm" ACTION="marked_inn.php3" METHOD="post">
				<INPUT NAME="cmd" TYPE="hidden" VALUE="addNew">
				<INPUT TYPE="hidden" NAME="addOK" VALUE="false"> 
				<P>Overskrift: <BR><INPUT TYPE="text" NAME="overskrift" SIZE="30"> 
				  <SELECT NAME="selg_kjop" SIZE="1"> 
					 <OPTION VALUE="selg">Selges</OPTION> 
					 <OPTION VALUE="kjop">Kj&oslash;pes</OPTION> 
				  </SELECT> <BR> Navn: <BR><INPUT TYPE="text" NAME="navn"
				  SIZE="30"> <BR> E-Mail: <BR><INPUT TYPE="text" NAME="email" SIZE="30"> </P> 
				<P>Melding: <BR><TEXTAREA NAME="kommentar" COLS="40" ROWS="10"></TEXTAREA></P> 
				<P>
				<input type="button" value="send" onMouseUp="validate();" class="buttons">&nbsp;*&nbsp;<INPUT
